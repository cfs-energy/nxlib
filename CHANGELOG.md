...
### Added
- Add a logger for nxlib and used the logger throughout. The primary use case for the logger is to capture log statements coming from the NX subprocess using the same logger as the caller.
